...
up is the right to keep paying out while a guard is up.
    ...
    def _guard_is_up(self) -> bool:
        try:
            return bool(gl.contract.get_at(gl.Address(self.guardian))
...
class Vault(gl.contract.Contract):
    ...
    def _would_break_the_floor(self, taking: str) -> bool:
        ...
        try:
            answer = json.loads(str(
                gl.contract.get_at(gl.Address(self.guardian)).view()
    ...
    def deposit(self) -> str:
        ...
        self.balances[who] = held + value
        self.deposited[who] = put_in + value
    ...
    def withdraw(self, amount: str) -> str:
        ...
        if self._guard_is_up():
            self.blocked = int(self.blocked) + 1
        ...
        self.balances[who] = held - taking
        self.taken[who] = taken_before + taking
        self._note({"kind": "withdraw", "who": who, "amount": taking})
        gl.contract.get_at(gl.message.sender_address).emit_transfer(taking)
